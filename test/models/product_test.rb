...
class ProductTest < ActiveSupport::TestCase
  ...
  test "product price must be positive" do
    product = Product.new(title:"My Book Ytile", description: "yyy", image_url: "zzz.jpg")
  ...
  def new_product(image_url)
    Product.new(title:"My Book Ytile", description: "yyy", price: 1, image_url: image_url)
  end
  ...
  test "product is not valid without a unique title" do
    ...
    product.title = "New title with 10 characters"
    assert product.valid?
  end

  test "title has to be at least 10 characters" do
    ...
    product.title = "New title long enough"
    product.valid?
  end
end
